...
<body>
<form action="employerupdate.php" method="post">
...
<div id="two"><h2>Enter your Employer Id:</h2></div>
<div id="emp"><input type="password" name="id" placeholder="EmpId" maxlength="20" size="50"></br></div>
<div id="b"><input type="submit" value="Enter"></div>
</form>
</body>
</html>