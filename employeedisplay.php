...
if(isset($_POST['eid'])&&isset($_POST['ename']))
{
$eid=$_POST['eid'];
$ename=$_POST['ename'];
$ab="call checklogin('$eid','$ename')";
...
<div id="a"><h3>Employee Login</h3></div>
<div id="two"><h2>Invalid Employee Id!</h2></div>
<div id="b"><a href="empllog.php"><h4>Try Again</h4></a></div>
</body>
</html>
<?php
}
...
{
?>
<title>Employee Details|Payroll Systems</title>
<style type="text/css">
